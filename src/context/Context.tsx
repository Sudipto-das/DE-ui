...
export const AppProvider = ({ children }: any) => {
  ...
  function setUserCookie(data: any) {
    ...
    document.cookie = `Id=${JSON.stringify(data.Id)}; expires=${date.toUTCString()}; path=/`;
    document.cookie = `Token=${JSON.stringify(data.Token)}; expires=${date.toUTCString()}; path=/`;
    document.cookie = `Email=${JSON.stringify(data.Email)}; expires=${date.toUTCString()}; path=/`;
    document.cookie = `Session=${JSON.stringify(data.Session)}; expires=${date.toUTCString()}; path=/`;
    document.cookie = `Name=${JSON.stringify(data.Name)}; expires=${date.toUTCString()}; path=/`;
    document.cookie = `RecId=${JSON.stringify(data.RecId)}; expires=${date.toUTCString()}; path=/`;
  }
