    ...
    return (
        <div>
            ...
            <div className="flex  flex-col gap-3 md:flex-row items-center justify-between mb-6 p-4 border rounded-lg ">
                ...
                <div className="ml-4">
                    <div className="relative inline-flex items-center justify-center p-1 overflow-hidden text-sm font-medium text-white rounded-lg group bg-gradient-to-br from-green-700 to-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300">
